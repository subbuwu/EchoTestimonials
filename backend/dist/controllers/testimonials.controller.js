...
function createTestimonial(data, formConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        const [created] = yield db_1.db
            ...
            .returning();
        return Object.assign(Object.assign({}, created), { formConfig: created.formConfig ? JSON.parse(created.formConfig) : null, customFields: created.customFields ? JSON.parse(created.customFields) : null, isPublished: created.isPublished === 'true' });
    });
}
// Public function to create testimonial submission (no auth check, but validates embedKey)
function createTestimonialSubmission(embedKey, data) {
    return __awaiter(this, void 0, void 0, function* () {
        // Find testimonial by embedKey to get the form and project
        const testimonialResult = yield db_1.db
            .select({
        ...
        const [updated] = yield db_1.db
            ...
            .returning();
        return Object.assign(Object.assign({}, updated), { customFields: updated.customFields ? JSON.parse(updated.customFields) : null, isPublished: updated.isPublished === 'true' });
    });
}
function getTestimonialsByProjectId(projectId, clerkId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return result.map((t) => (Object.assign(Object.assign({}, t), { formConfig: t.formConfig ? JSON.parse(t.formConfig) : null, customFields: t.customFields ? JSON.parse(t.customFields) : null, isPublished: t.isPublished === 'true' })));
    });
}
// Get testimonial by embedKey (public) - for form display
function getTestimonialByEmbedKey(embedKey) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield db_1.db
            .select({
            id: schema_1.testimonials.id,
        ...
        const t = result[0];
        return Object.assign(Object.assign({}, t), { formConfig: t.formConfig ? JSON.parse(t.formConfig) : null, customFields: t.customFields ? JSON.parse(t.customFields) : null, isPublished: t.isPublished === 'true' });
    });
}
function getTestimonialById(id, clerkId) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield db_1.db
            .select({
            id: schema_1.testimonials.id,
...
function updateTestimonial(id, clerkId, data, formConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        // First verify access
        const existing = yield getTestimonialById(id, clerkId);
        if (!existing) {
            return null;
        }
        const updateData = {
        ...
        const [updated] = yield db_1.db
            ...
            .returning();
        return Object.assign(Object.assign({}, updated), { formConfig: updated.formConfig ? JSON.parse(updated.formConfig) : null, customFields: updated.customFields ? JSON.parse(updated.customFields) : null, isPublished: updated.isPublished === 'true' });
    });
}
function deleteTestimonial(id, clerkId) {
    return __awaiter(this, void 0, void 0, function* () {
        // First verify access
        const existing = yield getTestimonialById(id, clerkId);
        if (!existing) {
